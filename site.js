const translations = {
  uk: {
    ...
    metaDescription: "Мої вебпроєкти: Братислава, Popularity, Auto Service, HAUS, MoneyMap, Квадро Бургер та Україна крізь століття.",
    brand: "Мої проєкти",
    nav: "Проєкти",
    ...
    intro: "Сім різних проєктів — від міського путівника та рейтингу до фінансового застосунку й онлайн-замовлень. Відкрийте кожен проєкт і перегляньте його.",
    scroll: "Дивитися проєкти",
    sectionEyebrow: "Портфоліо",
    sectionTitle: "Сім ідей. Сім світів.",
    live: "Живий сайт",
    project: "Проєкт",
    open: "Відкрити сайт",
    ...
    ukraineCategory: "Історичний сайт",
    ukraineTitle: "Україна крізь століття",
    ukraineDescription: "Інтерактивний історичний сайт із хронологією, мапою регіонів і сторінками областей.",
    footer: "Створено з увагою до змісту, деталей і людей."
  },
  sk: {
    pageTitle: "Moje projekty — webové portfólio",
    metaDescription: "Moje webové projekty: Bratislava, Popularity, Auto Service, HAUS, MoneyMap, Quadro Burger a Ukrajina naprieč stáročiami.",
    brand: "Moje projekty",
    nav: "Projekty",
    ...
    intro: "Sedem odlišných projektov — od mestského sprievodcu a rebríčka až po finančnú aplikáciu a online objednávky. Otvorte si každý projekt a pozrite si ho.",
    scroll: "Pozrieť projekty",
    sectionEyebrow: "Portfólio",
    sectionTitle: "Sedem nápadov. Sedem svetov.",
    live: "Web je online",
    project: "Projekt",
    open: "Otvoriť web",
    ...
    ukraineCategory: "Historický web",
    ukraineTitle: "Ukrajina naprieč stáročiami",
    ukraineDescription: "Interaktívny historický web s chronológiou, mapou regiónov a stránkami oblastí.",
